...
/**
 *  Used by the ViewPager in {@link FacilityDetailFragment} to show the user inspection records
...
public class InspectionFragment extends Fragment {
  ...
  /**
   * Empty constructor meant to be utilized by the
   * {@link #newInstance(String, String, String, String, String)}
   */
   ...
   * @param vCode Violation code.
   * @param vDesc Violation description.
   * @param memo Inspection memorandum. Not all inspection records have memorandums.
   * @return {@link InspectionFragment}
   */
